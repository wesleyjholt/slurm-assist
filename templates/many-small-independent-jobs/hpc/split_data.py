...
def main(
    ...
    """Split data into batches, save to files, and create all necessary directories."""
    
    create_dirs(results_dir, tmp_dir)
    ...
    for k, batch in enumerate(data_batches):
        ...
        data_batch_filepath = os.path.join(data_batch_dir, f'{i}_{j}.pkl')
